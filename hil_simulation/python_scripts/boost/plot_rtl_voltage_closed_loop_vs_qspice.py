...
run_closed_loop = pqs('boost_voltage_closed_loop.qsch')
...
vhdl_data.plot(ax=axT, x="time", y="volt", label="rtl vhdl voltage")
# vhdl_data.plot(ax=axT, x="time", y="vref", label="vhdl reference voltage")
vhdl_data.plot(ax=axB, x="time", y="curr", label="rtl vhdl current")
