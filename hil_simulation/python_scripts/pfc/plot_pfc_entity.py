...
vhdl_ref_data = pd.read_csv('./pfc_entity_tb_ref.dat', delim_whitespace=True)

vhdl_data.plot(ax=axT, x="time", y="volt", label="dc link voltage")
vhdl_ref_data.plot(ax=axT, x="time", y="volt", label="dc link voltage ref")
# vhdl_data.plot(ax=axT, x="time", y="rvin", label="input voltage")
vhdl_data.plot(ax=axB, x="time", y="curr", label="input current")
vhdl_ref_data.plot(ax=axB, x="time", y="curr", label="input current ref")
