-- VHDL netlist generated by SCUBA Diamond (64-bit) 3.11.1.441
-- Module  Version: 5.7
--C:\Programs\diamond\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n main_pll -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 50 -fclkop 130 -fclkop_tol 1.0 -fclkos 260 -fclkos_tol 1.0 -phases 0 -phase_cntl STATIC -lock -sticky -fb_mode 1 -fdc C:/Users/Jari/mycodeprojects/tube_power_v5/lfe5u/ip_cores/ip_cores/main_pll/main_pll.fdc 
...
architecture Structure of main_pll is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "260.000000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "130.000000";
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  3, PLL_LOCK_MODE=>  2, 
        ...
        CLKOS2_DIV=>  1, CLKOS_DIV=>  2, CLKOP_DIV=>  4, CLKFB_DIV=>  13, 
