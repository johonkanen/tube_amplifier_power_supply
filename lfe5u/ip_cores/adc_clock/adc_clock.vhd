...
-- Module  Version: 5.7
--C:\Programs\diamond\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n adc_clock -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 50 -fclkop 240 -fclkop_tol 0.0 -phase_cntl STATIC -lock -sticky -fb_mode 1 -fdc C:/Users/Jari/mycodeprojects/tube_power_v5/lfe5u/ip_cores/ip_cores/adc_clock/adc_clock.fdc 
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  2, PLL_LOCK_MODE=>  2, 
        ...
        CLKOS2_DIV=>  1, CLKOS_DIV=>  1, CLKOP_DIV=>  3, CLKFB_DIV=>  24, 
