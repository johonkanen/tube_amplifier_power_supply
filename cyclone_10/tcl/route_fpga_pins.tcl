proc place_fpga_pins_for_10CL010YU256I7G {} \
{
    ...
    set_location_assignment PIN_A13 -to system_control_FPGA_out.component_interconnect_FPGA_out.power_supply_control_FPGA_out.llc_control_FPGA_out.hb_llc_gates.llc_gates.pri_high
    set_location_assignment PIN_A12 -to system_control_FPGA_out.component_interconnect_FPGA_out.power_supply_control_FPGA_out.llc_control_FPGA_out.hb_llc_gates.llc_gates.pri_low
    set_location_assignment PIN_A15 -to system_control_FPGA_out.component_interconnect_FPGA_out.power_supply_control_FPGA_out.llc_control_FPGA_out.hb_llc_gates.llc_gates.sync1
    set_location_assignment PIN_D16 -to system_control_FPGA_out.component_interconnect_FPGA_out.power_supply_control_FPGA_out.llc_control_FPGA_out.hb_llc_gates.llc_gates.sync2
