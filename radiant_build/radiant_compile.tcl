...
prj_set_strategy_value -strategy Strategy1 {syn_cmdline_args=set_option -vhdl2019 1}

add_vhdl_file_to_project $tcl_path/IP/main_oscillator/main_oscillator.ipx
add_vhdl_file_to_project $tcl_path/IP/main_clock/main_clock.ipx
add_vhdl_file_to_project $tcl_path/certus_nx_top.vhd
add_vhdl_file_to_project $tcl_path/../source/efinix_top.vhd

source $source_folder/../list_of_sources.tcl
source $source_folder/../fpga_communication_sources.tcl
add_vhdl_file_to_project $tcl_path/../source/float_configuration/certus_nx_float_configuration_pkg.vhd
