...
xst -ifn xst.scr
move s6_core_clocks_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\s6_core_clocks_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc s6_core_clocks_exdes.ucf s6_core_clocks_exdes

echo 'Running map'
map -timing -pr b s6_core_clocks_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm s6_core_clocks_exdes -w routed.ncd routed.vhd
cd ..
